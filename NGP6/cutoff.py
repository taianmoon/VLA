...
input_fits_image_band1='./NGP6_initial_clean.image.tt0.fits'  #=====250
...
try:
    montage.mSubimage(input_fits_image_band1, './NGP6D1_cutout.fits', ra=200.74129, dec=33.403903, xsize=0.01666666666)
except:
